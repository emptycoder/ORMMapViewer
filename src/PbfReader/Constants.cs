...
namespace ORMMap.VectorTile.Contants
{
	/// <summary>
	///     PBF wire types
	/// </summary>
	...
	/// <summary>
	///     Root types contained in the vector tile. Currently just 'Layers'
	///     https://github.com/mapbox/vector-tile-spec/blob/master/2.1/vector_tile.proto#L75
	/// </summary>
